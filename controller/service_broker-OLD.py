...
def install_functions():    
    ...
    install()
    return '<h2> Installing functions to the nodes... <br/> <a href="http://127.0.0.1:5000/index"> Back </a> </h2>'
...
if __name__ == '__main__':
    ...
    #app.run(host="172.17.0.1", port=5000) #5000
    app.run(host="127.0.0.1", port=5050) #5000
